  ...
  return (
    <div className='max-w-[1400px] m-auto py-16 px-4 grid lg:grid-cols-2 gap-4'>
      ...
      <div className='py-10 mb-10 flex justify-center items-center'>
        <img className='row-span-4 object-cover w-full h-full p-2' src={Profile} alt="/" style={{width:'450px'}} />
        {/*<img className='row-span-2 object-cover w-full h-full p-2' src={Profile} alt="/" />
